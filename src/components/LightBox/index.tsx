		...
		<div onClick={(e) => e.stopPropagation()}>
			...
			<div tabIndex={0}>
				<div className="relative">
					<div className="flex max-h-[600px] w-full max-w-5xl overflow-hidden rounded">
						<div
				...
				<div className="scrollbar-hide mt-4 flex max-w-5xl snap-x snap-proximity overflow-y-hidden overflow-x-scroll">
					<div
						className={`flex h-full w-full gap-2 ${
							images.length <= 6 ? "justify-center" : "justify-start"
						}`}>
						{open
